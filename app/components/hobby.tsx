...
import hobby1 from '../BermainGame.jpeg';
import hobby2 from '../Bulutangkis.jpeg';
import hobby3 from '../Mainbola.jpeg';
import hobby4 from '../Berenang.jpeg';

const HobbiesGallery: React.FC = () => {
  const hobbies = [
    { id: 1, title: 'Gaming', image: hobby1 },
    { id: 2, title: 'Badminton', image: hobby2 },
    { id: 3, title: 'Main Bola', image: hobby3 },
    { id: 4, title: 'Berenang', image: hobby4 },
  ];
